...
const CATEGORY_LABELS: Record<CategoryKey, string> = {
  phishing_payment: "Financial fraud or phishing",
  threatening_messages: "Online threats, stalking or harassment",
  investment_deepfake: "AI-generated harmful or deceptive content",
...
export function checklistToComplaintDetails({ category, values = {}, confirmed = false, today = new Date() }: ToComplaintDetailsArgs): ComplaintDetails {
  const details: ComplaintDetails = {
    selectedCategory: CATEGORY_LABELS[category] || category,
