...
export function AdminConsole() {
  ...
  return <div className="page admin-page">
    ...
    <section className="admin-heading"><div><span className="eyebrow">CONFIGURATION PREVIEW</span><h1>Administration</h1><p>Review subject folders, human routing controls, analysis safeguards, and accountability. Staffing and service controls shown here are illustrative.</p></div><div className="admin-identity"><span><LockKeyhole size={15}/> ADMIN ACCESS</span><strong>Authorised administrator</strong><small>Human-controlled workspace</small></div></section>
