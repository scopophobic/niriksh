...
def render_report(case: dict) -> str:
    ...
    lines = [
        ...
        f"Human-selected subject folder: {case.get('category', 'Other / needs category review')}",
        "Review policy: No automated priority, guilt, or routing decision is included.",
        ...
        f"Proposed team: {routing.get('primaryUnit', 'Human routing required')}",
        "Final destination: Must be confirmed by an authorised officer",
        "",
