  ...
  return <div className="landing-page">
    ...
    <main>
      <section className="landing-hero">
        ...
        <aside className="landing-preview-card"><div className="landing-preview-head"><span><FileCheck2 size={21}/></span><div><small>WHAT YOU RECEIVE</small><strong>A report you can understand</strong></div></div><div className="landing-preview-summary"><small>AT A GLANCE</small><h2>Facts with their sources</h2><p>The selected subject folder, reported impacts, source-linked details, and missing information are shown before the longer evidence record.</p></div><div className="landing-preview-items"><span><i>1</i><div><strong>Plain-language summary</strong><small>What the system organised</small></div></span><span><i>2</i><div><strong>Incident timeline</strong><small>What happened and when</small></div></span><span><i>3</i><div><strong>Human review path</strong><small>Who can confirm the next step</small></div></span></div></aside>
      </section>
      ...
      <section className="landing-how" id="how-it-works"><div className="landing-section-heading"><small>SIMPLE BY DESIGN</small><h2>From incident to human review</h2><p>Four clear stages. The system organises source material; people make the decisions.</p></div><div className="landing-how-grid"><article><span><FileText/></span><small>STEP 1</small><h3>Tell us what happened</h3><p>Choose the closest subject folder, then add the date, platform, and any files or links you have.</p></article><article><span><BrainCircuit/></span><small>STEP 2</small><h3>The pipeline organises the evidence</h3><p>The complaint and supported media become source-backed context, a timeline, and missing information—without a priority score.</p></article><article><span><FileCheck2/></span><small>STEP 3</small><h3>Review the report</h3><p>Check the details, timeline, and evidence explanation before continuing.</p></article><article><span><Route/></span><small>STEP 4</small><h3>A person confirms the destination</h3><p>An authorised reviewer checks the subject folder, jurisdiction, and appropriate team.</p></article></div></section>
