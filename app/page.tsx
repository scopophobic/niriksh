...
export default function Home() {
  return <div className="landing-v3">
    ...
    <main id="main-content">
      ...
      <section className="awareness-reel" id="awareness"><div className="awareness-reel-copy"><p>Awareness, when the intelligence is ready</p><h2>A place for simple, human-reviewed scam explainers.</h2><span>This space creates video, image, and text awareness content from verified patterns—not from unreviewed AI guesses.</span><div className="awareness-reel-notes"><span><Check/>One pattern, one clear lesson</span><span><Check/>Video, image, or text format</span><span><Check/>Human approval before publishing</span></div></div><div className="awareness-video-placeholder"><div className="video-orbit"><span/><span/><span/><Play/></div><div><Video/><strong>Awareness content studio</strong><small>Reviewed guidance in the right format</small></div><em>Available after verification</em></div></section>
