...
export default function Home() {
  return <div className="landing-v3">
    ...
    <main id="main-content">
      ...
      <section className="whatsapp-story" id="whatsapp-reporting"><div className="whatsapp-story-copy"><p>WhatsApp-style reporting</p><h2>Report in the conversation you already understand.</h2><span>Niriksh’s guided chat helps someone explain what happened without guessing which form field comes next. It checks the required information as the conversation develops, asks focused follow-ups, and keeps the person in control before anything is filed.</span><Link className="story-primary" href="/whatsapp"><MessageCircle/>Try the reporting demo <ArrowRight/></Link><small>This is a self-contained Niriksh demo, not a live Meta/WhatsApp connection.</small></div><div className="whatsapp-flow-card"><div className="whatsapp-flow-head"><MessageCircle/><div><strong>Niriksh reporting assistant</strong><span>Guided intake · ready when you are</span></div><i/></div><div className="whatsapp-bubble bot">Tell me what happened in your own words. I’ll help organise the details.</div><div className="whatsapp-bubble user">A message promised guaranteed returns and asked me to pay a fee.</div><div className="whatsapp-bubble bot"><strong>Let’s check what is still needed</strong><span><Check/>What happened</span><span><Check/>Contact channel</span><span className="pending"><ClipboardCheck/>Payment identifier or link</span><span className="pending"><Camera/>Evidence, if safe to share</span></div><div className="whatsapp-flow-footer"><span><Mic/>Voice note</span><span><Camera/>Photo</span><b>Send when ready</b></div></div></section>
